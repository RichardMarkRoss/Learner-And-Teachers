...
public class TeachersTest {
    ...
    @Test
    public void ShouldTestNewTeacherStored(){
        Teacher teacher = new Teacher("Richard","Killer","Unalo@gmail.com", Subjects.valueOf("Afrikaans"));
        ...
        assertEquals("new teacher added", teacher.storePerson());
